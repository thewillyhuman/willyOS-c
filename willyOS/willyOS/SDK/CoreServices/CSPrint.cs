...
namespace CoreServices {
	...
	public class CSPrint {
		...
		public static void print<T>(string separator = default(string), string terminator = default(string), params T[] items) {
		...
		/// <param name="terminator">Terminator.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public static void print<T>(IEnumerable<T> items, string separator = default(string), string terminator = default(string)) {
			foreach(var col in items) {
				Console.Write(col + separator);
			}
			Console.WriteLine(terminator);
		...
		/// <param name="items">Items.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public static void print<T>(string separator = default(string), params T[] items) {
